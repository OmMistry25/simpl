...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={ref}
        className="relative mt-[80rem] animate-fade-up opacity-0 [--animation-delay:400ms] [perspective:2000px] after:absolute after:inset-0 after:z-50 after:[background:linear-gradient(to_top,hsl(var(--background))_30%,transparent)]"
      >
        <div
